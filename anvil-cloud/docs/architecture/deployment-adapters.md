...
AWS is the first planned deployment adapter for v0. That should prove the adapter contract, not turn AWS into the Cell authoring model.
...
- Implementing more than one production cloud adapter in v0.
- Abstracting every cloud provider feature.
- Supporting arbitrary containers, Kubernetes, or enterprise networking in v0.
...
4. Add further adapters only after v0 validates the contract.
