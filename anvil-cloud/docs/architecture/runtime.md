...
The runtime should not rely on convention alone for security, but v0 may begin with compiler/import restrictions and capability checks rather than full effect tracking.
