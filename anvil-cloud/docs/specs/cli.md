...
Deploys a Cell to a preview environment through the configured deployment adapter. AWS is the first planned v0 adapter.

In v0, deploy may be implemented after local runtime, builder, manifest, and the deployment adapter contract are stable.
