...
It explicitly rejects glossy cybersecurity vendor sludge, generic SaaS dashboard wallpaper, theatrical hacker-terminal styling, corporate DevSecOps content mulch, fake urgency, black-and-neon threat theatre, and heroic metrics with no receipts.
...
### Don't:
- **Don't** make Anvil feel like glossy cybersecurity vendor sludge, generic SaaS dashboard wallpaper, theatrical hacker-terminal styling, or corporate DevSecOps content mulch.
