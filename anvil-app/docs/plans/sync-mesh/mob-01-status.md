...
- Lint blocked by a pre-existing ESLint 10 / `eslint-plugin-react` incompatibility (`contextOrFilename.getFilename is not a function`) — tooling issue, not a code finding.
