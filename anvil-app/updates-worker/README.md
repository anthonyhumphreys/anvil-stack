...
This Worker serves macOS update metadata and signed release binaries from a private R2 bucket. Electron and the public website never read GitHub release assets during the normal update path.
