  ...
  return (
    <ScreenBackground accent={COLORS.red} secondary={COLORS.green} ghostLabel="Gate">
      <AppFrame activeNav="Governance">
        <div
          style={{ display: 'flex', flexDirection: 'column', height: '100%', padding: 30, gap: 22 }}
        >
          <div style={{ display: 'flex', justifyContent: 'space-between', gap: 20 }}>
            ...
            <div style={{ display: 'flex', gap: 14, alignItems: 'flex-start' }}>
              <StatCard
                ...
                value="08"
                detail="Across concept, delivery, and operation"
                tone="amber"
                style={{ width: 220 }}
              />
              <StatCard
                label="Gate 4"
                value="Ready"
                detail="Evidence assembled for Build → Run"
                tone="green"
                style={{ width: 220 }}
              />
            </div>
              ...
              >
                ...
                <div style={{ marginTop: 14, display: 'flex', flexDirection: 'column', gap: 10 }}>
                  {[
                    ...
                    ['Governance doc refresh', 'Shape', COLORS.cyan],
                  ...
                  >
                    ...
                    >
                      <StatCard
                        label="Repos Linked"
                        value="03"
                        detail="API, portal, docs"
                        tone="cyan"
                      />
                      <StatCard
                        label="Dependencies"
                        value="07"
                        detail="Cross-service impacts tracked"
                        tone="amber"
                      />
                      <StatCard
                        label="Decision Pack"
                        value="Ready"
                        detail="Executive summary plus technical appendix"
                        tone="green"
                      />
                    </div>
                  </FrostPanel>
