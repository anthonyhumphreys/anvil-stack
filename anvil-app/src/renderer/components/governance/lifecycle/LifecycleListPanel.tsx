      ...
      <div className="flex items-center justify-between border-b border-border px-3 py-2">
        ...
        <div className="flex items-center gap-1">
          ...
          <button
            ...
            className="flex items-center gap-1 rounded-md bg-accent px-2 py-1 text-xs font-medium text-accent-foreground hover:bg-accent/90"
          >
            <Plus size={12} />
            New
          </button>
            ...
            {items.map((item) => (
              ...
              >
                ...
                <button
                  ...
                  className="absolute right-2 top-2 rounded p-0.5 text-text-tertiary opacity-0 hover:text-error group-focus-within:opacity-100 group-hover:opacity-100"
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
      <div className="w-[520px] rounded-lg border border-border bg-bg-secondary shadow-xl">
        ...
        <div className="space-y-2 p-4">
          ...
          {error && <div className="rounded bg-error/10 px-3 py-2 text-xs text-error">{error}</div>}
        </div>
        ...
        <div className="flex items-center justify-between border-t border-border px-4 py-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              onClick={save}
              className="rounded bg-accent px-3 py-1.5 text-sm font-medium text-accent-foreground hover:bg-accent/90 disabled:opacity-60"
              disabled={saving}
            >
              {saving ? 'Saving...' : 'Save'}
            </button>
