...
describe('initializeAppUpdater', () => {
  ...
  it('configures the stable feed and checks after startup and every four hours', async () => {
    ...
    expect(electronMocks.autoUpdater.setFeedURL).toHaveBeenCalledWith({
      url: 'https://github.com/anthonyhumphreys/anvil-stack/releases/download/app-updates/anvil-macos-arm64-updates.json',
      serverType: 'json',
    });
