...
describe('artifact download', () => {
  it('fetches bytes and verifies the manifest checksum', async () => {
  ...
  it('rejects non-published manifests', async () => {
    rpcHandler = () => ({
      manifest: {
        id: 'art-9',
        attemptId: 'att-1',
...
describe('artifact listing/get', () => {
  it('lists manifests for an attempt', async () => {
