...
| Lens              | Local Lens is served at `/_anvil/lens` and reads the same local runtime truth as CLI JSON: manifest, capabilities, auth users, logs, usage totals, active database branch, database state, workflows, services, and diagnostics.                                                                                                                                                                                        |
