...
| Local runtime     | Local HTTP server, JSON database with snapshot branches and TTL cleanup, files, auth, logs, events, jobs, workflows, supervised services, manifest, and inspection state exist.                                                                                                                                                                                                                                        |
| CLI               | `new`, `dev`, `check`, `review`, `build`, `agents`, `inspect`, `logs`, `usage`, `db` table and branch lifecycle commands, `workflows`, `services list`, named `deploy --preview`, `rollback --preview --dry-run`, and `destroy --preview` exist.                                                                                                                                                                      |
...
| Lens              | Local Lens is served at `/_anvil/lens` and reads the same local runtime truth as CLI JSON: manifest, capabilities, auth users, logs, active database branch, database state, workflows, services, and diagnostics.                                                                                                                                                                                                      |
