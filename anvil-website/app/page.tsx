        ...
        <div className="flex flex-col gap-8">
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:flex-wrap">
            ...
            <Button asChild size="lg" variant="outline">
              <Link href="/docs/project/repositories">Map the repos</Link>
            </Button>
            <Button asChild size="lg" variant="outline">
              <Link href={desktopRepositoryUrl}>
  ...
  return (
    <section id="products" className="border-b bg-muted/20 py-14">
      <div className="mx-auto grid max-w-7xl gap-8 px-4 sm:px-6 lg:grid-cols-[0.58fr_1.42fr] lg:px-8">
        <SectionHeading
          title="Three repos, three boundaries"
          description="The split is intentional. Desktop coordinates local work, Registry controls dependency ingress, and Cloud constrains app runtime contracts."
        />
        ...
        <div className="flex flex-col justify-between gap-5 sm:flex-row sm:items-end">
          ...
          <div className="flex flex-wrap gap-2">
            <Button asChild variant="outline">
              <Link href={cloudRepositoryUrl}>
                <Github data-icon="inline-start" aria-hidden="true" />
                anvil-cloud
              </Link>
            </Button>
            <Button asChild variant="outline">
              <Link href={registryRepositoryUrl}>
                <Github data-icon="inline-start" aria-hidden="true" />
                anvil-registry
              </Link>
            </Button>
